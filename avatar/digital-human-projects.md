...
## 活跃度采样观察（浅克隆、仅供后续跟踪）
> 2025-12-26 本地 `--depth 20` 浅克隆并统计，尚未下结论，可随时间重复采样。计数为 git log 的提交数。

| 项目 | 近 30 天提交 | 近 60 天提交 | 近 90 天提交 | 最新 5 次提交（日期 简述） |
| --- | --- | --- | --- | --- |
| Duix-Avatar | 0 | 0 | 3 | 2025-10-16 Merge PR#554; 2025-10-16 README 更新; 2025-09-28 Linux GPU 修复; 2025-09-25 服务名重命名; 2025-09-18 Docker server 名更新 |
| Duix-Mobile | 2 | 4 | 25 | 2025-12-16 合并主分支; 2025-12-16 修复 bug; 2025-11-19 大小写调整; 2025-11-19 文档更新; 2025-10-22 README 更新 |
| LivePortrait | 0 | 1 | 1 | 2025-11-16 链接修复; 2025-06-14 README 更新; 2025-06-01 README 更新; 2025-06-01 README 更新; 2025-05-29 badge 更新 |
| LiveTalking | 0 | 3 | 5 | 2025-11-23 MuseTalk 音频嵌入; 2025-11-08 README 更新; 2025-11-08 连接关闭优化; 2025-10-26 潜在内存泄漏修复; 2025-10-03 README-EN 更新 |
| facefusion | 2 | 6 | 6 | 2025-12-17 本地化命名修正; 2025-12-13 3.5.2 补丁; 2025-11-19 3.5.1; 2025-11-07 命令修正; 2025-11-03 3.5.0 |
| SadTalker | 0 | 0 | 0 | 2023-10-11 Colab 更新; 2023-09-15 PR#624 合入; 2023-09-15 PR#606 合入; 2023-09-15 PR#635 合入; 2023-09-12 WebUI 致命错误修复 |
| Ultralight-Digital-Human | 0 | 0 | 0 | 2025-09-18 README 更新; 2025-06-17 注释与优化; 2025-06-15 inference bug 修复; 2025-06-15 hubert 编码器 bug 修复; 2025-06-04 README |

后续可增加：
- 按周/按月的提交节奏可视化；
- PR/issue 合并耗时、CI 通过率；
- 代码质量抽样（lint/测试覆盖率提示）。

近况简评（仅根据最近 90 天活动与提交类型）：
- **持续高频**：facefusion（功能与修复均有）、Duix-Mobile（功能/文档/修复密集）。
- **中等活跃**：LiveTalking（近 90 天 5 次，含内存泄漏修复）；Duix-Avatar（近 90 天 3 次，主要配置/修复）。
- **低频/停更风险**：LivePortrait（近期仅 1 次链接修复）、Ultralight-Digital-Human（9 月后无新提交）、SadTalker（2023-10 之后无提交）。
